...
private Q_SLOTS:
    ...
    void testParseStartTime()
    {
        ...
        struct icaltimetype itt = icaltime_from_timet_with_zone(startTime.toTime_t(), FALSE, nullptr);
        dt.value = &itt;
        dt.tzid = "";
        ...
        itt = icaltime_from_timet_with_zone(endTime.toTime_t(), FALSE, nullptr);
        dt.value = &itt;
